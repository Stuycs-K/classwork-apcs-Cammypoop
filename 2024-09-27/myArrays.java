public class myArrays{
    ...
    public static void main(String[] args) {
        ...
        a = new int[]{1,3,4,5};
        System.out.println("Variable: " + "[1, 3, 4, 5]"  + ". Returned: " + returnCopy(a) + ".");
        a = new int[]{5,6,13};
        System.out.println("Variable: " + "[5, 6, 13]"  + ". Returned: " + returnCopy(a) + ".");
        a = new int[]{1};
        System.out.println("Variable: " + "[1]"  + ". Returned: " + returnCopy(a) + ".");
    }
}
